/*!
 * Start Bootstrap - Meman 2 v4.0.7 (https://startbootstrap.com/template-overviews/sb-admin-2)
...
function addRecord() {
  ...
  var b = document.getElementById("enterAmount").value;
  var c = document.getElementById("enterType").value;

  var dataEntry = c + "  " + a + b;
  document.getElementById("showData").innerHTML = dataEntry;
